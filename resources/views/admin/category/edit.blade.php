...
<div class="max-w-md">
    ...
    <div class="mb-6">
        ...
        <p class="font-sans text-sm text-zinc-600 mt-1">
            Ubah nama kategori kegiatan "{{ $category->name }}".
        </p>
    </div>
    ...
    <div class="bg-white border-4 border-black p-6 md:p-8 shadow-brutalist-md">
        ...
        <form action="{{ route('admin.category.update', $category) }}" method="POST" class="flex flex-col gap-6">
            @csrf
            @method('PUT')
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <span class="text-[10px] text-zinc-500 font-sans mt-1">
                    Slug URL akan disesuaikan secara otomatis berdasarkan perubahan nama kategori.
                </span>
                @error('name')
